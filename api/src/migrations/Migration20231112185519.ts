...
export class Migration20231112185519 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('create table "movie_session" ("session_id" serial primary key, "start_date" timestamptz(0) not null, "end_date" timestamptz(0) not null, "theatre_name" varchar(255) not null, "theatre_address" varchar(255) not null, "theatre_city" varchar(255) not null, "movie_movie_id" int not null);');
