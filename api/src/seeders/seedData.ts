...
export default async (em: EntityManager): Promise<void> => {
  ...
  const movieSessionsData = [
    ...
    {
      startDate: new Date('2023-12-14T08:00:00Z'),
      endDate: new Date('2023-12-14T10:30:00Z'),
      theatreName: 'Cinéma Lumière',
      theatreAddress: '12 Rue de la Liberté',
      theatreCity: 'Paris',
      movie: 1,
    ...
    {
      startDate: new Date('2023-12-14T10:45:00Z'),
      endDate: new Date('2023-12-14T13:15:00Z'),
      theatreName: 'Le Grand Rex',
      theatreAddress: '1 Boulevard Poissonnière',
      theatreCity: 'Paris',
      movie: 2,
    ...
    {
      startDate: new Date('2023-12-14T13:30:00Z'),
      endDate: new Date('2023-12-14T16:00:00Z'),
      theatreName: 'Cinéma Gaumont',
      theatreAddress: '27 Rue du Jeu des Enfants',
      theatreCity: 'Strasbourg',
      movie: 3,
    ...
    {
      startDate: new Date('2023-12-14T16:15:00Z'),
      endDate: new Date('2023-12-14T18:45:00Z'),
      theatreName: 'Pathé Bellecour',
      theatreAddress: '79 Rue de la République',
      theatreCity: 'Lyon',
      movie: 4,
    ...
    {
      startDate: new Date('2023-12-14T19:00:00Z'),
      endDate: new Date('2023-12-14T21:30:00Z'),
      theatreName: 'UGC Ciné Cité',
      theatreAddress: '6 Rue du Docteur Charles Nancel Penard',
      theatreCity: 'Bordeaux',
      movie: 5,
    ...
    {
      startDate: new Date('2023-12-14T21:45:00Z'),
      endDate: new Date('2023-12-15T00:15:00Z'),
      theatreName: 'Cinéma Lumière',
      theatreAddress: '12 Rue de la Liberté',
      theatreCity: 'Paris',
      movie: 5,
    ...
    {
      startDate: new Date('2023-12-14T00:30:00Z'),
      endDate: new Date('2023-12-14T03:00:00Z'),
      theatreName: 'Le Grand Rex',
      theatreAddress: '1 Boulevard Poissonnière',
      theatreCity: 'Paris',
      movie: 4,
    ...
    {
      startDate: new Date('2023-12-14T03:15:00Z'),
      endDate: new Date('2023-12-14T05:45:00Z'),
      theatreName: 'Cinéma Gaumont',
      theatreAddress: '27 Rue du Jeu des Enfants',
      theatreCity: 'Strasbourg',
      movie: 1,
    ...
    {
      startDate: new Date('2023-12-14T06:00:00Z'),
      endDate: new Date('2023-12-14T08:30:00Z'),
      theatreName: 'Pathé Bellecour',
      theatreAddress: '79 Rue de la République',
      theatreCity: 'Lyon',
      movie: 3,
    ...
    {
      startDate: new Date('2023-12-14T08:45:00Z'),
      endDate: new Date('2023-12-14T11:15:00Z'),
      theatreName: 'UGC Ciné Cité',
      theatreAddress: '6 Rue du Docteur Charles Nancel Penard',
      theatreCity: 'Bordeaux',
      movie: 2,
